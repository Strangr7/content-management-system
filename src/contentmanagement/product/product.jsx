...
const Product = () => {
  ...
  <div className="overflow-x-auto bg-white rounded-lg shadow">
    ...
    <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200">
      ...
      <button className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md flex items-center gap-2" onClick= {() => navigate('/contentmanagement/product/createproduct')}>
        <svg 
        ...
        <tr>
          ...
          <td className="px-6 py-4 whitespace-nowrap text-sm">
            <div className="flex space-x-2">
              <button className="bg-green-500 hover:bg-green-600 text-white p-2 rounded-md" onClick= {() => navigate('/contentmanagement/product/updateproduct')}>
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
                  className="h-4 w-4" 
                  viewBox="0 0 20 20" 
